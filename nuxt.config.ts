...
export default defineNuxtConfig({
    ...
    runtimeConfig: {
        ...
        IVAO_VOICE_USERNAME: process.env.IVAO_VOICE_USERNAME,
        IVAO_VOICE_PASSWORD: process.env.IVAO_VOICE_PASSWORD,
        ...
        IVAO_CLIENT_ID: process.env.IVAO_CLIENT_ID,
        IVAO_CLIENT_SECRET: process.env.IVAO_CLIENT_SECRET,
        IVAO_ENDPOINT: process.env.IVAO_ENDPOINT,
        ...
        DISCORD_ROLE_ATC_AS1: process.env.DISCORD_ROLE_ATC_AS1,
        DISCORD_ROLE_ATC_AS2: process.env.DISCORD_ROLE_ATC_AS2,
        DISCORD_ROLE_ATC_AS3: process.env.DISCORD_ROLE_ATC_AS3,
        DISCORD_ROLE_ATC_ADC: process.env.DISCORD_ROLE_ATC_ADC,
        DISCORD_ROLE_ATC_APC: process.env.DISCORD_ROLE_ATC_APC,
        DISCORD_ROLE_ATC_ACC: process.env.DISCORD_ROLE_ATC_ACC,
        DISCORD_ROLE_ATC_SEC: process.env.DISCORD_ROLE_ATC_SEC,
        DISCORD_ROLE_ATC_SAI: process.env.DISCORD_ROLE_ATC_SAI,
        DISCORD_ROLE_ATC_CAI: process.env.DISCORD_ROLE_ATC_CAI,

        DISCORD_ROLE_PILOT_P0: process.env.DISCORD_ROLE_PILOT_P0,
        DISCORD_ROLE_PILOT_FS: process.env.DISCORD_ROLE_PILOT_FS,
        DISCORD_ROLE_PILOT_FS1: process.env.DISCORD_ROLE_PILOT_FS1,
        DISCORD_ROLE_PILOT_FS2: process.env.DISCORD_ROLE_PILOT_FS2,
        DISCORD_ROLE_PILOT_FS3: process.env.DISCORD_ROLE_PILOT_FS3,
        DISCORD_ROLE_PILOT_PP: process.env.DISCORD_ROLE_PILOT_PP,
        DISCORD_ROLE_PILOT_SPP: process.env.DISCORD_ROLE_PILOT_SPP,
        DISCORD_ROLE_PILOT_CP: process.env.DISCORD_ROLE_PILOT_CP,
        DISCORD_ROLE_PILOT_ATP: process.env.DISCORD_ROLE_PILOT_ATP,
        DISCORD_ROLE_PILOT_SFI: process.env.DISCORD_ROLE_PILOT_SFI,
        DISCORD_ROLE_PILOT_CFI: process.env.DISCORD_ROLE_PILOT_CFI,

    ...
    features: [
        {
            ...
            description: 'This is a major IVAO Radar update. Read <a href="https://docs.ivao-radar.com/changelog.html#_2-0-0" target="_blank" class="__link">Full Changelog</a> for more details',
        ...
        },
        {
            ...
            description: 'Visit <a href="https://docs.ivao-radar.com/changelog.html#_2-0-0" target="_blank" class="__link">Full Changelog</a> for more details',

<template>
    ...
    >
        <div class="map-footer_left">
            ...
            <div
                v-if="(store.friends.length || store.bookmarks.length) && store.viewport.width >= 700 && favoriteLocation.value === 'footer'"
                class="map-footer_left_section"
            >
                <ui-button
            ...
            <div class="map-footer_left_section __desktop">
                ...
                >
                    <div class="map-footer__connections_title">
                        <span>{{ getCounts.total }}</span> connections with <span>{{ getCounts.inRadar }}</span> in IVAO Radar
                    </div>
